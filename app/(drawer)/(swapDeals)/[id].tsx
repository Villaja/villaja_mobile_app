...
const Page: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchProductDetails = async () => {
      try {
        const response = await axios.get(`${base_url}/quick-swap/get-product/${id}`);
        setProductDetails(response.data.quickSwapProduct);
          ...
          <>
              {productDetails && (
                <>
                  ...
                  <Carousel
                  data={productDetails?.userProductImages}
                    ...
                    <View style={{ gap: 12 }}>
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>Screen Condition</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.screenCondition || 'N/A'}</Text>
                        </View>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>Cosmetics Condition</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.cosmeticsCondition || 'N/A'}</Text>
                        </View>
                      </View>
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>Comes With</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.comesWith || 'N/A'}</Text>
                        </View>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>Gadget Condition</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.gadgetCondition || 'N/A'}</Text>
                        </View>
                      </View>
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>RAM Size</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.ramSize || 'N/A'}</Text>
                        </View>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>ROM Size</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.storageSize || 'N/A'}</Text>
                        </View>
                      </View>
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>yearsUsed</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.os || 'N/A'}</Text>
                        </View>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>location</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.location || 'N/A'}</Text>
                        </View>
                        
                      </View>
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>Phone Number</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.phoneNumber || 'N/A'}</Text>
                        </View>
