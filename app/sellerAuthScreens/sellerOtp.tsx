...
import { ScrollView, View, Text, Image, TextInput, TouchableOpacity, StyleSheet, NativeSyntheticEvent, TextInputKeyPressEventData } from "react-native";
...
const sellerOtp = () => {
    ...
    return (
        <View style={defaultStyles.container}>
            <Text style={{ alignSelf: 'center', fontSize: 23, fontFamily: "roboto-condensed-sb", color: Colors.primary }}>OTP Verification</Text>
            <Text style={{ color: "rgba(0,0,0,0.50)", fontFamily: 'roboto-condensed', alignSelf: 'center', marginTop: 24, fontSize: 13 }}>Enter the OTP sent to <Text style={{ color: Colors.primary }}>You@Example.com</Text></Text>
            ...
            <Text style={{ color: "rgba(0,0,0,0.50)", fontFamily: 'roboto-condensed', alignSelf: 'center', marginTop: 12, fontSize: 13 }}>Didn't Receive OTP? <Text style={{ color: Colors.primary }}>Resend</Text></Text>
