                ...
                <View style={{}}>
                  ...
                  <View style={{ backgroundColor: "#fff", padding: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 8, paddingVertical: 16 }}>
                      ...
                      <TouchableOpacity style={[defaultStyles.btnStyleBorder, { flexBasis: '49%' }]} onPress={sendMessage}><Text style={[defaultStyles.btnText, { fontSize: 16, fontFamily: 'roboto-condensed', color: Colors.primary }]} >Message Seller</Text></TouchableOpacity>
                    </View>
                  </View>
                  ...
                  <View style={{ marginTop: 10, paddingVertical: 20, paddingHorizontal: 20, backgroundColor: '#fff' }}>
                    ...
                    <View style={{ gap: 12 }}>
                      ...
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>STORAGE CAPACITY</Text>
                      ...
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>OPERATING SYSTEM</Text>
                      ...
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>DISPLAY TYPE</Text>
                          <Text style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.displaySize || 'N/A'}</Text>
                        </View>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
                          <Text style={{ fontFamily: 'roboto-condensed', color: 'rgba(0,0,0,0.40)', fontSize: 12, lineHeight: 15.2 }}>WARRANTY</Text>
                          <Text numberOfLines={1} style={{ fontFamily: 'roboto-condensed', textTransform: 'capitalize', fontSize: 15 }}>{productDetails?.tags || 'N/A'}</Text>
                        </View>
                      </View>
                      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ gap: 4, flexBasis: '49%' }}>
